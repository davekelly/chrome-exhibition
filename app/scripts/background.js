...
function setBounds(restore) {
    chrome.system.display.getInfo(function(displays) {
        ...
        if (display) {
            ...
            // runtime.lastError is thrown without this check. 
            // 
            // Because the function below is only available in 
            // ChromeOS and this probably isn't running there...
            if(typeof(chrome.system.display.setDisplayProperties) === 'function'){
