// Generated on 2014-08-15 using generator-chromeapp 0.2.13
'use strict';
    ...
    grunt.initConfig({
        ...
        mocha: {
            all: {
                options: {
                    run: true,
                    urls: ['http://localhost:<%= connect.options.port %>/window.html']
                }
            }
        },
        ...
        // By default, your `window.html`'s <!-- Usemin block --> will take care of
            ...
            dist: {
                options: {
                    archive: function() {
                        ...
                        return 'package/exhibition app ahssrb-' + manifest.version + '.zip';
                    }
                },
                files: [{
                    expand: true,
